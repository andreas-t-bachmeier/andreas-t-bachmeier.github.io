(function () {
  ...
  function loadLinkedIn(){
    ...
    tag.onload = function(){ console.log("[consent] LinkedIn tag loaded. lintrk =", typeof window.lintrk); };
    tag.onerror = function(e){ console.warn("[consent] LinkedIn tag load error", e); };
  ...
  /* ========== Banner UI (original look) ========== */
  function addBannerStyles(){
    // Hover effect only (rest is inline to match your original)
    var style = document.createElement("style");
    style.textContent =
      "#cookie-banner button{transition:background-color .3s}" +
      "#cookie-banner button:hover{background-color:rgba(255,100,0,.8)}";
  ...
  function createCookieBanner(){
    ...
    // Buttons container (original layout)
    var btns = document.createElement("div");
    btns.style.cssText = "margin-top:10px; display:flex; justify-content:center; gap:10px; flex-wrap:wrap;";

    // Accept (original look)
    var accept = document.createElement("button");
    accept.textContent = "Accept";
    accept.style.cssText = "font-family:'Inter', sans-serif; color:#000; background:#FF6400; border:none; padding:10px; width:45%; max-width:400px; cursor:pointer;";
    ...
    // Decline (original look)
    var decline = document.createElement("button");
    decline.textContent = "Decline";
    decline.style.cssText = "font-family:'Inter', sans-serif; color:#000; background:#FF6400; border:none; padding:10px; width:45%; max-width:400px; cursor:pointer;";
