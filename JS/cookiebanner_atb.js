(function(){
  ...
  function loadGoogleAnalytics() {
    ...
    script.async = true;
    // Replace G-KYK8CCBZ29 with your actual GA tracking ID
    script.src = "https://www.googletagmanager.com/gtag/js?id=G-KYK8CCBZ29";
    document.head.appendChild(script);

    window.dataLayer = window.dataLayer || [];
    function gtag(){ dataLayer.push(arguments); }
    gtag('js', new Date());
    gtag('config', 'G-KYK8CCBZ29', { 'anonymize_ip': true });
  }
  ...
  function createCookieBanner() {
    ...
    para.innerHTML = "This website uses cookies to ensure you get the best experience. " +
                     "<a href='cookie-policy.html' target='_blank' style='color:#FF6400; text-decoration:underline;'>Review Privacy Policy</a>";
